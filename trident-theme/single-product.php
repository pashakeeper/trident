<?php
/**
 * Template Name: Product Page Template,Item CARD
 *
        ...
        <div class="row main_row">
            ...
            <div class="col-lg-6">
                ...
                <div class="interior_nav">
                    <div class="interior_prev custom_nav" style="">
                        <i class="fa fa-angle-left"></i>
                    </div>
                    <div class="interior_next custom_nav" style="">
                ...
                <div class="interior_box">
                    ...
                    <ul class="nav">
                        ...
                        $interior_photo = $interior['interior_photo']; foreach ($interior_photo as $photo):
                            ?>
                            <li><img src="<?php echo $photo['interior_images'] ?>" alt="" /></li>
                        <?php endforeach; ?>
                    </ul>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php echo $technical['usable_area'] ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div class="plans_box">
                    <?php foreach ($florplans as $img): ?>
                        <div class="plan_box__image">
                            <img src="<?php echo $img['item_floorplans_image'] ?>" alt="">
