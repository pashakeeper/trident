    ...
    <section class="item_section" id="item_section">
        <div class="container">
            <div class="row main_row">
                <div class="col-lg-5">
                    ...
                    <div class="breadcrumbs w-100 mt-4 mb-4">
                      <?php wp_breadcrumbs(); ?>
                  </div>
                  <?php the_content(); ?>
              </div>
              <div class="col-lg-7">
                ...
                <div class="interior_slider">
                    ...
                    <?php if ($item_slider): ?>
                        <?php foreach ($item_slider as $item_slide): ?>
                            <div class="slide">
                                <img data-fancybox="gallery" src="<?php echo $item_slide['item_slider_image']; ?>" alt="" />
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
                ...
                <div class="interior_slider_thumb">
                    <?php if ($item_slider): ?>
                        <?php foreach ($item_slider as $item_slide): ?>
                            <div class="slide">
                                <img  src="<?php echo $item_slide['item_slider_image']; ?>" alt="" />
                            </div>
                        <?php endforeach; ?>
                    <?php   else: ?>
                        <div class="text-center">NO DATA</div>
        ...
        <div class="row video_row">
            ...
            <div class="col-lg-7 video_box">
                <?php $video_src = get_field('item_video'); ?>
                <div class="video">
                    <?php if ($video_src['item_video_image_placeholder']): ?>
                    ...
                    <?php else: ?>
                        <img src="<?php echo get_template_directory_uri();?>/img/video_placeholder.jpg" alt="">
                    <?php   endif; ?>
                </div>
            </div>
            <div class="col-lg-5 ">
                <div class="interior_box">
                    ...
                    <ul class="nav">
                        ...
                        $interior_photo = $interior['interior_photo'];  
                        if ($interior_photo):
                            foreach ($interior_photo as $photo):
                                ?>
                ...
                <div class="col-lg-7 pr-0 ml-auto document_container">
                ...
                <div class="row technical_row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <?php if ($technical): ?>
                         <table>
                            <tbody>
                              ...
                              <td><?php echo $technical['usable_area'] ?> ft² (86.67 m²)</td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <td><?php echo $technical['number_of_floors'] ?></td>
                      </tr>
                      <tr>
                        <td>
                      ...
                      <td><?php echo $technical['number_of_rooms'] ?></td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <td><?php echo $technical['number_of_bathrooms'] ?></td>
              </tr>
              <tr>
                <td>
              ...
              <td><?php echo $technical['angle_of_roof_pitch'] ?>°</td>
          </tr>
          <tr>
            <td>
          ...
          <td><?php echo $technical['garage'] ?></td>
      </tr>
  </tbody>
</table>
<?php else: ?>
...
<div class="col-lg-6 document_container__mobile">
    ...
    <div class="col-lg-6 floorplans_box ml-auto">
        <h4>Floorplans</h4>
        <div class="plans_box">
            <?php if($florplans): ?>
...
<?php $small_boxes = get_field('item_advantages_block', 'option');?>
      ...
      <?php foreach($small_boxes as $adv_box): ?>
          <div class="col-lg-3">
            <div class="advantages_box">
              <img src="<?php echo $adv_box["item_advantages_image"] ?>" alt="" />
              <?php echo $adv_box["item_advantages_content"] ?>
          </div>
      </div>
  <?php endforeach; ?>
</div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content" id="houseTabs">
                        <div class="tab-pane fade show active" id="basicmodel" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <div class="col-lg-8">
                                    <?php if ($basic_model['model_series']): ?>
                        ...
                        <div class="tab-pane fade" id="premiummodel" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <div class="col-lg-8">
                                    <?php if ($premium_model['model_series']): ?>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <thead>
                                                <tr>
                                                    <th>Series</th>
                        ...
                        <div class="house_slider garden recent">
                            <?php if (have_posts()): ?>
                                <?php while (have_posts()):
                                    the_post(); ?>
                                    <div class="slide">
                                        <a href="<?php the_permalink(); ?>"><img data-lazy="<?php echo the_post_thumbnail_url(); ?>"
                                        src="<?php echo the_post_thumbnail_url(); ?>" alt=""> </a>
                                        <h3 class="house_name">
